...
const ADDITIONAL_BLOCKS = [
  ...
  },
  {
    ...
    prices: [],
    note: 'Перепад высот более 1 м — коэфф. 1,3. *Модели растений за счёт заказчика при отсутствии в библиотеке. Для участков площадью более 50 соток — цена договорная.',
  },
];
